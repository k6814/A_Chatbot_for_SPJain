...
defaultResp = {
    'bdva' : 'You can have a word with Mr. Rakesh Shetty, M: +91- xxxxxxxxxx | Email id xxxxxxxxxx@spjain.org. He handles all the application for the Big Data and Visual Analytics Course.',
    'dmm' : 'I would like to inform you that we have our Admissions Manager Mr. Ashutosh Kulkarni, based out of Mumbai.  He handles all applications for Digital Marketing and Metrics . You can get in touch with him directly. His contact details are tel no +91 xxxxxxxxxx, email id xxxxxxxxxx@spjain.org . He would be your point of contact as far as DMM @ S P Jain is concerned.',
    'rm' : 'You can have a word with Mr. Ashutosh Kulkarni, M: +91 xxxxxxxxxx, email id xxxxxxxxxx@spjain.org. He handles all applications for Retail Management.',
    'emba': 'I would like to inform you that we have our Assistant Manager- Professional Programs for EMBA Ms. Nikita Marwaha , based out of our Mumbai Campus. Ms. Nikita handles all applications for the EMBA program. You can get in touch with her directly. Her contact details are tel no xxxxxxxxxx email id xxxxxxxxxx@spjain.org. She would be your point of contact as far as EMBA @ S P Jain is concerned.',
    'gmba': 'I would like to inform you that we have our Admissions Manager Ms. Mona Dabas, based out of New Delhi. Ms. Mona handles all applications for MGB and GMBA coming from your region. You can get in touch with her directly. Her contact details are tel no +91 xxxxxxxxxx. Email id xxxxxxxxxx@spjain.org. She would be your point of contact as far as PG @ S P Jain is concerned',
    'mgb' : 'I would like to inform you that we have our Admissions Manager Mr. Noel Thomas, based out of Mumbai. Mr. Noel handles all applications for MGB and GMBA coming from your region. You can get in touch with him directly. His contact details are tel no +91 xxxxxxxxxx, email id xxxxxxxxxx@spjain.org. He would be your point of contact as far as PG @ S P Jain is concerned.',
    'mba' : 'I would like to inform you that we have our Admissions Manager Mr. Noel Thomas, based out of Mumbai. Mr. Noel handles all applications for MGB and GMBA coming from West India You can get in touch with him directly. His contact details are tel no +91 xxxxxxxxxx, email id xxxxxxxxxx@spjain.org. He would be your point of contact as far as PG @ S P Jain is concerned.',
    'dba' : 'I would like to inform you that we have our Director- Professional PG Programs Dr. Raja Roy Choudhury, based out of Mumbai.  He handles all applications for DMM/DBA. You can get in touch with him directly. His contact details are tel no xxxxxxxxxx/xxxxxxxxxx, email id xxxxxxxxxx@spjain.org  . He would be your point of contact as far as DBA/DMM @ S P Jain is concerned.',
    ...
    'bba' : 'I would like to inform you that we have our Admissions Manager Mr. Atharv Kale, based in Mumbai.  Atharv handles all applications for BBA, BBC and BEC coming from your region. You can get in touch with him directly. His contact details are Tel no +91 xxxxxxxxxx, email id: xxxxxxxxxx@spjain.org. He would be your point of contact as far as BBA, BBC and BEC @ S P Jain is concerned.',
    'bec' : 'I would like to inform you that we have our Admissions Manager Mr. Atharv Kale, based in Mumbai.  Atharv handles all applications for BBA, BBC and BEC coming from your region. You can get in touch with him directly. His contact details are Tel no +91 xxxxxxxxxx, email id: xxxxxxxxxx@spjain.org. He would be your point of contact as far as BBA, BBC and BEC @ S P Jain is concerned.',
    'bbc' : 'You can have a word with Mr. Mahesh Sharma, M: +91-xxxxxxxxxx  | Email id ***@spjain.org. He handles all the application for the Bachelor Of Business Communication.',
    ...
    'fintech': 'I would like to inform you that we have our Admissions Manager Mr.Nikhil Gore , based out of Mumbai.  He handles all applications for Fintech  . You can get in touch with him directly. His contact details are tel no +91 xxxxxxxxxx, email id xxxxxxxxxx@spjain.org. He would be your point of contact as far as DMM @ S P Jain is concerned.'
